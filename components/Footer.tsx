...
export function Footer() {
  return <footer className="site-footer"><div className="site-shell footer-grid">
    <div><Link className="logo" href="/"><img src="/logos/SORIANO_Grupo_Inmobiliario_logo_transparente.png" alt="Soriano Grupo Inmobiliario" /></Link><p className="footer-intro">{editableCopy.footer}</p></div>
    <div><p className="footer-title">Navegar</p><Link href="/">Inicio</Link><Link href="/inmuebles">Comprar</Link><Link href="/vender">Vender</Link><Link href="/contacto">Contactar</Link></div>
