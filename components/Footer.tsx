...
export function Footer() {
  return <footer className="site-footer"><div className="site-shell footer-grid">
    ...
    <div><p className="footer-title">Contacto</p>{siteConfig.phone && <a href={`tel:${siteConfig.phone.replaceAll(" ", "")}`}>{siteConfig.phone}</a>}<a href={`mailto:${siteConfig.email}`}>{siteConfig.email}</a><p>{siteConfig.address}</p></div>
