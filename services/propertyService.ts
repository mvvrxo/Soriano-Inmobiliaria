...
export const demoProperties: Property[] = [
  ...
  { id: "demo-sitges", slug: "atico-terraza-sitges", title: "Ático con gran terraza", description: "Luz, amplitud y una terraza para vivir el Mediterráneo. Disponible para alquiler de larga duración.", propertyType: "Ático", operation: "alquiler", location: "Sitges", province: "Barcelona", price: 2100, area: 112, bedrooms: 3, bathrooms: 2, features: ["Terraza", "Ascensor", "Vistas al mar"], images: ["https://images.unsplash.com/photo-1600566753086-00f18fb6b3ea?auto=format&fit=crop&w=1600&q=85"], status: "published", featured: false, createdAt: "2026-09-01", updatedAt: "2026-09-01" },
];
